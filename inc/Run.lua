...
─────▀██▀─────
│nigthwing ‿ @xxxli
تم تطوير وبرمجة السورس من قبل بروس │
│@xxxli ‿ @xxxli 
#-------------------------------------------------------------------
]]
...
print('\n\27[1;31m￤ Conect is Failed !\n￤ حدث خطـا في الاتصـال بالسـيرفر , يرجى مـراسـلهہ‏‏ مـطـور السـورس ليتمـكن مـن حل المـشـكلهہ‏‏ في اسـرع وقت مـمـكن . !')
create_config(Token)
end
...
•~│ اختصـاصـي حمـايهه‌‏ المـجمـوعات
•~│ مـن السـبام والتوجيهه‌‏ والتكرار والخ...
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com//TEMmax/max/master/plugins/games.lua','./plugins/games.lua')
...
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'•*¦* تم رفع النسـخهه‏‏ الاحتياطيه\n•~*¦* حاليا عدد مـجمـوعاتك هہ‏‏يهه‏‏ *'..redis:scard(max..'group:ids')..'* •~\n•')
	end
