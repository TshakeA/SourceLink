...
if not msg.Admin then return " هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ."
end
...
if not msg.Admin then return "هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ." end
...
.."\n عدد مساعدين المدير < ❪ *"..data.administrator_count_.."* ❫"
...
if MsgText[1] == "مساعد المدير" then 
if not msg.Admin then return "هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ." end
...
if not msg.Admin then return "هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ." end
return ownerlist(msg) ..GetChannelMembers(msg) .. GetListAdmin(msg) .. whitelist(msg)
end
...
if MsgText[1] == "المالكين اساسي" then 
if not msg.Admin then return "هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ." end
return MONSEBOT(msg) 
end
...
if MsgText[1] == "مساعدين المدراء" then 
if not msg.Admin then return "هذا الامر يخص ( مساعد المدير,المدير,المالك,المطور ) فقط ." end
...
if not msg.Director then return "هذا الامر يخص ( المطور,المالك,المدير ) فقط ." end
...
if not msg.Creator then return "هذا الامر يخص ( المطور,المالك ) فقط ." end
if not MsgText[2] and msg.reply_id then
if redis:get(max..'lock:kara:'..msg.chat_id_) == 'off' then
...
if (MsgText[1] == "رفع مالك اساسي" or MsgText[1] == "رفع مالك الاساسي") then
if not msg.SudoUser then return "هذا الامر يخص ( Dev, Mester ) فقط ." end
if not MsgText[2] and msg.reply_id then 
...
if (MsgText[1] == "تنزيل مالك اساسي" or MsgText[1] == "تنزيل المالك الاساسي") then
if not msg.SudoUser then return "هذا الامر يخص ( Dev, Mester ) فقط ." end
if not MsgText[2] and msg.reply_id then 
...
if MsgText[1] == "رفع مساعد مدير" then
if not msg.Kara then return "هذا الامر يخص ( مالك فما فوق ) فقط ." end
if not MsgText[2] and msg.reply_id then
if redis:get(max..'lock:kara:'..msg.chat_id_) == 'off' then
...
if MsgText[1] == "تنزيل مساعد مدير" then
if not msg.Kara then return "هذا الامر يخص ( مالك اساسي فما فوق ) فقط ." end
if not MsgText[2] and msg.reply_id then
...
return 'عزيزي قم بإرسال الرابط الجديد ...'
end
...
if res == 403 then
return "عذرا عزيزي \nلم استطيع ارسال لك الرابط لانك قمت بحظر البوت ."
elseif res == 400 then
return "عذرا عزيزي \nلم استطيع ارسال لك الرابط يجب عليك مراسله البوت اولا ."
end
if res == 200 then 
return "أهلا عزيزي "..msg.TheRankCmd.."  \nتم ارسال الرابط الخاص لك "
end
end
...
if MsgText[2] == "مساعد المدير" then 
if not msg.Director then return "هذا الامر يخص ( المطور,المالك,المدير ) فقط ." end

local Admins = redis:scard(max..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "او هنالك خطأ\nعذرا لا يوجد مساعدين مدير ليتم مسحهم ." 
end
redis:del(max..'admins:'..msg.chat_id_)
return "أهلا عزيزي "..msg.TheRankCmd.."   \nتم مسح {"..Admins.."} من مساعد المدير في البوت ."
end
...
if not msg.Director then return "هذا الامر يخص ( المطور,المالك,المدير ) فقط ." end
if not redis:get(max..'rulse:msg'..msg.chat_id_) then 
return "عذرا لا يوجد قوانين ليتم مسحها ." 
end
...
if MsgText[2] == "مالك الاساسي" then
...
return ".أهلا عزيزي "..msg.TheRankCmd.."   \nتم مسح (  "..NumMnsha.."  ) مالك الاساسي ."
end


if MsgText[2] == "مالكين" then
if not msg.SudoUser then return "هذا الامر يخص ( المطور ) فقط ." end
...
if not msg.Creator then return "هذا الامر يخص ( المطور,المالك,المدير ) فقط ." end
local NumMDER = redis:scard(max..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
...
if not msg.Director then return "هذا الامر يخص ( المطور,المالك ) فقط ." end
...
لـديـك {]]..total..[[} بـوتـات
ملاحظة : الـنـ★ـجـمـه تعنـي ان البوت مشرف في المجموعـة.]]
...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		if not redis:get("KLISH:ID") then
		sendMsg(msg.chat_id_,msg.id_,'لا يمكنني عرض صورتك لانك قمت بحظر البوت او انك لاتملك صوره في بروفايلك ...!\n- USE : '..UserNameID..' .\n- MSG : '..msgs..' .\n- STA : '..msg.TheRank..' .\n- iD : '..msg.sender_user_id_..' .\n- (@SouurceLink) . ',dl_cb,nil)
		else
		Text = redis:get("KLISH:ID")
		Text = Text:gsub('IDGET',msg.sender_user_id_)
		Text = Text:gsub('USERGET',UserNameID)
...
return 'عدد جهاتك المـضـافه‏‏ < ❪ '..(redis:get(max..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ .'
end
...
if points == 0 then  return " عذرا ليس لديك نقاط لكي يتم مسحها لاتسوقها تكفى ؟." end
...
if MsgText[2] == "ردود بن" 	then return unlock_replay(msg) end
if MsgText[2] == "الاذاعه" 	then return unlock_brod(msg) end
if MsgText[2] == "ايدي بن" 	then return unlock_ID(msg) end
if MsgText[2] == "ترحيب بن" 	then return unlock_Welcome(msg) end
...
if MsgText[2] == "ردود بن" 	then return lock_replay(msg) end
if MsgText[2] == "الاذاعه" 	then return lock_brod(msg) end
if MsgText[2] == "ايدي بن" 	then return lock_ID(msg) end
if MsgText[2] == "ترحيب بن" 	then return lock_Welcome(msg) end
...
if MsgText[1] == "رفع مساعد المدير" then
if not msg.Creator then return "هذا الامر يخص ( المطور,المالك ) فقط ." end
...
if not msg.SudoBase then return "هذا الامر يخص ( Mester ) فقط ." end
if not MsgText[2] and msg.reply_id then 
...
if #groups == i then
local GroupDel = #groups - GroupsIsFoun 
if GroupDel == 0 then
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[اهلاً اسمي ]]..redis:get(max..':NameBot:')..[[ ✅
من اختصاصي حماية القروبات من البوتات الايرانيه
و مـن السبام و التوجيه و التكرار واشياء اكثر ...

My dev:   ]]..SUDO_USER:gsub([[\_]],'_')..[[ 
]])
...
return 'تم وضـع شـرط تفعيل البوت اذا كان في المـجمـوعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  \n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'شـرط تفعيل البوت اذا كان في المجموعه اكثر مـن *【'..redis:get(max..':addnumberusers')..'】* عضـو  \n' 
end 
end
...
if MsgText[1] == "قائمة D" or MsgText[1] == " D list" then
...
return "هذا الامر يخص ( Mester ) فقط ." 
end
...
if MsgText[1] == "كتم عام" then
if not msg.SudoBase then return "هذا الامر يخص ( Mester ) فقط ." end
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,action_by_reply,{msg=msg,cmd="silentall"}) 
return false
end
if MsgText[2] and MsgText[2]:match('^%d+$') then 
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="ktmall"}) 
return false
end
if MsgText[2] and MsgText[2]:match('@[%a%d_]+') then 
GetUserName(MsgText[2],action_by_username,{msg=msg,cmd="silentall"}) 
return false
end 
end

if MsgText[1] == "الغاء كتم العام" or MsgText[1] == "الغاء عام" then
if not msg.SudoBase then return"هذا الامر يخص ( Mester ) فقط ." end
  
if not MsgText[2] and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,action_by_reply,{msg=msg,cmd="unsilentall"}) 
return false
end
if MsgText[2] and MsgText[2]:match('^%d+$') then 
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="unktmall"}) 
return false
end
if MsgText[2] and MsgText[2]:match('@[%a%d_]+') then 
GetUserName(MsgText[2],action_by_username,{msg=msg,cmd="unsilentall"}) 
return false
end 
end 
...
return '- اصدار سورس ليِنك   : *v'..version..'* .'
end
...
sendMsg(msg.chat_id_,msg.id_,'عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس لينك يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم .')
end  
else
...
if not msg.SudoBase then return"هذا الامر يخص ( المطور الاساسي ) فقط ." end
return " البوت شـغــال جعلني بس آهه 🥺🖤. " 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي") and msg.type == "pv" then return  "\n اهلاً عزيزي المطور ايديك تفضل  \n\n"..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس " and msg.type == "pv" then
local inline = {{{text="•قناه‏‏ السـورس اضـغـط هـنـا ",url="https://t.me/nightwingsource"}}}
send_key(msg.sender_user_id_,'  [قناة سورس : انـجـل](https://t.me/nightwingsource)',nil,inline,msg.id_)
return false
end
...
━━━━━━━
1- رفع × تنزيل » مدير
2- رفع × تنزيل » مساعد مدير
3- رفع × تنزيل » مميز
━━━━━━━
» اوامر المسح
━━━━━━━
1- مسح الادمنـيـه » لمسح مساعد المدير
...
اذا تبي شي كلمني هنا ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,MarkDown)
return false
end
...
return [[
[-𝐒𝐎𝐔𝐑𝐂𝐄_𝐋𝐈𝐍𝐊.  سورس ليِنك .](https://t.me/SouurceLink)
[-𝐃𝐄𝐕_𝐒𝐎𝐔𝐑𝐂𝐄𝐋𝐈𝐍𝐊.   مطور السورس .](https://t.me/SQQQC)
]]
end
...
text = [[اهلاً اسمي []]..redis:get(max..':NameBot:')..[[]
من اختصاصي حماية القروبات من البوتات الايرانيه
و مـن السبام و التوجيه و التكرار واشياء اكثر ....

ًلتفعيل البوت اتبع مايلي .  
...
return sendMsg(msg.chat_id_,msg.id_,"حلو, ذحين تقدر ترسل جواب الردالعام \n[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] .")
end
end
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(max..':WELCOME_BOT'),[[•اهلاً اسمي ]]..redis:get(max..':NameBot:')..[[ 
•من اختصاصي حماية القروبات من البوتات الايرانيه .
...
sendMsg(msg.chat_id_,msg.id_,'•على زق .')
...
return sendMsg(msg.chat_id_,msg.id_,'•تم تغيير صـورة الترحيب للبوت .')
end 
...
return sendMsg(msg.chat_id_,msg.id_,"•حلو, ذحين تقدر ترسل جواب الرد \n•[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] .")
end
end
...
elseif Text== "تاللددلبياتتاااف" then return sendMsg(msg.chat_id_,msg.id_,"وجعع .")
elseif Text== "سورس مين" then return sendMsg(msg.chat_id_,msg.id_,"[فارس العامري ..](t.me/SQQQC")
elseif Text== "فارس" then return sendMsg(msg.chat_id_,msg.id_,"[فارس العامري](t.me/SQQQC")
elseif Text== "جاستن" then return sendMsg(msg.chat_id_,msg.id_,"[جاسـتـن الـزهـرانـي ..](t.me/VVV_IP")
elseif Text== "اديب" then return sendMsg(msg.chat_id_,msg.id_,"[آديــب الـزهـرانـي - ](t.me/VVV_IP")
elseif Text== "اعشقتيتبتبتبتتبتبتنتتك"  then return sendMsg(msg.chat_id_,msg.id_,"اموت فيك .")
elseif Text== "وتبتيتياايتيتيينك"  then return sendMsg(msg.chat_id_,msg.id_,"بقلبك .")
elseif Text== "غنتبتبتبتبتببتبتبتبي"  then return sendMsg(msg.chat_id_,msg.id_,"شوف لك سورس عراقي .")
elseif Text== "هاتيتيتيتيتيتيتيي"  then return sendMsg(msg.chat_id_,msg.id_,"افخم هاي .")
elseif Text== "رفع ايايتياييتتيتيتيايخادم"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع العضو بنجاح لصيبح خادم\nلقد اصبح من فئة الخدم.\n✅️")
elseif Text== "تنزيلايايتيتيتيتيتيتصنيرير خادم"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيله من فئة الخدم\n ولقد تم ارجاعه الى عضو .\n✅️")
elseif Text== "رفع ايايتيتيتيتيتيتيتيتيتيكلبي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع العضو إلى كلب بنجاح\n لقد تمت إضافته إلى قائمه الكلاب .\n✅️")
elseif Text== "رفع ايايايايتيتيتيايايايتستايورعي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع العضو إلى ورعك بنجاح\n  تم إضافته إلى ابنائك.\n✅️")
elseif Text== "تنزيل ايايتيايتييتيتتيورعي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيل ورعك بنجاح\n تم طرده من قبل ابنائك.\n✅️")
elseif Text== "تنزيلزيتيتيتيتيتيتيتيتيتي كلبي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي \n تم تنزيل كلبك بنجاح\n تمت إزالته من فئة الكلاب  .\n✅️")
elseif Text== "تنزيليااياايايتيتيتيتثتي حمار"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيل الحمار بنجاح\n تمت ازالته من قائمه الحمير.\n✅️")
elseif Text== "رفعزييتتييتتيتيتسيعيزث حمار"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع العضو إلى حمار بنجاح\n  تم إضافته إلى قائمة الحمير .\n✅️")
elseif Text== "رفع زيايايعيعيعيستيتعييتصعيتسربوت"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع السربوت بنجاح\n الان اصبح بقائمة السرابيت .\n✅️")
elseif Text== "تنزيل زيايايايتيتيتتييتتيسربوت"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيل السربوت بنجاح\n تمت ٳزالته من قائمة السرابيت.\n✅️")
elseif Text== "رفعتيتيتيتيتيتثعثعثعثتزي قلبي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع العضو داخل قلبك\n تمت ترقيته بنجاح ♥️\n✅️")
elseif Text== "تنزيل منزيايايايتيتيتيايتياياياي قلبي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيل من داخل قلبك\n تمت ازالته ♥️\n✅️")
elseif Text== "رف ايايتيايعيتييتستيتع ملك"  then return sendMsg(msg.chat_id_,msg.id_," اهـلا عزيزي\n تم رفع العضو الى ملك بنجاح \n اصبح ملك المجموعه . \n✅️")
elseif Text== "تنزييزيتتييتعيتسريتسنتقعثل ملك"  then return sendMsg(msg.chat_id_,msg.id_," اهـلا عزيزي\n تم طرد الملك \nلقد تم طرده وارجاعه الى رتبته السابقه .\n✅️")
elseif Text== "رفعيزياتيتصتستبتثعسعيتي زوجتي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم رفع المزه لتصبح زوجتك بنجاح\nالان تقدرون تجيبون عيال .\n✅️")
elseif Text== "تنزيلزيايتسسننيسرنسنسيعتستسهستيتيز زوجتي"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم تنزيل المزه ولم تعد زوجتك \nمب كيفك تتزوج وترمي .\n✅️")
elseif Text== "زاياياساساساياثاثواج"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم زواجكم الاثنين بنجاح\n ذحين تقدرون تقفلون الباب وتلعبون سوا .\n✅️")
elseif Text== "طلايايتستسنستيايايايتياياق"  then return sendMsg(msg.chat_id_,msg.id_," اهــلا عزيزي\n تم طلاقكم بنجاح \n وخرو عن بعض وكل مين يروح بيت اهله ..\n✅️")

elseif Text== "ايديي" or Text=="اييدي" then 
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"- هذا هو ايديك يغالي .\n\n "..USERNAME.." ⇆ ( "..data.id_.." )",37,USERCAR)  
return false
end)
--=====================================
