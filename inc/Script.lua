...
if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي") and msg.type == "pv" then return  "\n•**اهلاً عزيزي المطور ايديك هوه \n\n•~"..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس " and msg.type == "pv" then
local inline = {{{text="•قناه‏‏ السـورس اضـغـط هـنـا ",url="https://t.me/"}}}
send_key(msg.sender_user_id_,'  [•قناة سورس : لينك](https://t.me/)',nil,inline,msg.id_)
return false
end
...
11- كشف بالمعرف > لمعرفه معلومات الحساب
12- كشف بالرد > لمعرفه معلومات الحساب
...
return [[
[-𝐒𝐎𝐔𝐑𝐂𝐄𝐋𝐈𝐍𝐊.](https://t.me/SouurceLink)
[-𝐃𝐄𝐕 𝐒𝐎𝐔𝐑𝐂𝐄𝐋𝐈𝐍𝐊](https://t.me/SQQQC)
...
elseif Text== "عبدالمحسن" then return sendMsg(msg.chat_id_,msg.id_,"[RAY.](t.me/END_Q")
elseif Text== "فارس" then return sendMsg(msg.chat_id_,msg.id_,"[ 𝐅.](t.me/ZTTTD")
elseif Text== "حسين" then return sendMsg(msg.chat_id_,msg.id_,"[ BRUCE.](t.me/xxxli")
